...
export const dictionaries: Record<Locale, Record<MessageKey, string>> = {
  "zh-TW": {
    ...
    "field.successSignalsHelp": "列出可觀察的成功跡象；建議至少一條附上可量測的指標與門檻，方便事後檢驗。",
    "field.successSignalsPlaceholder": "例：平均作業耗時下降、使用者滿意度評分提升、相關客服支援請求減少",
    "field.successSignalStatement": "陳述",
    "field.successSignalStatementHelp": "用一句話描述觀察到什麼算成功。",
    "field.successSignalStatementPlaceholder": "例：註冊轉換率提升 15%",
    "field.successSignalMetric": "可量測指標（選填）",
    "field.successSignalMetricHelp": "對應的指標名稱、儀表板欄位或事件名稱。",
    "field.successSignalMetricPlaceholder": "例：signup_completion_rate",
    "field.successSignalThreshold": "門檻（選填）",
    "field.successSignalThresholdHelp": "達標條件，可寫成數值、比例或範圍。",
    "field.successSignalThresholdPlaceholder": "例：> 0.15、< 5 件 / 週",
    "field.successSignalKind": "訊號類型（選填）",
    "field.successSignalKindHelp": "Leading 為前導指標，Lagging 為事後驗證指標。",
    "kind.leading": "領先（Leading）",
    "kind.lagging": "落後（Lagging）",
    "kind.unset": "未設定",
    ...
    "validation.successSignalsNotMeasurable":
      "目前的成功訊號都沒有可量測的指標（metric / threshold）；建議至少一條附上可驗證的數據契約，方便事後 build–measure–learn。",
...
`,
    ...
    "seedPrompt.button.sendToAgent": "→ 送進右側 AI Agent",
    "seedPrompt.button.sentToAgent": "已送出 ✦",
    ...
    "assistant.title": "本地 AI Agent",
    "assistant.warning": "⚠ 此 agent 可直接讀寫專案檔並執行指令（bypassPermissions）。每次送出皆為獨立 session。",
    "assistant.placeholder": "例如：用 vector-pipeline-b stage 1 處理：我想做習慣追蹤 app",
    "assistant.send": "送出",
    "assistant.sending": "處理中…",
    "assistant.abort": "中止",
    "assistant.clear": "清空對話",
    "assistant.collapse": "收合",
    "assistant.expand": "開啟 AI 助手",
    "assistant.empty": "輸入需求，agent 會在這個專案內讀寫檔案並回報進度。",
    "assistant.you": "你",
    "assistant.agent": "Agent",
    "assistant.toolResult": "結果",
    "assistant.toolError": "失敗",
    "assistant.toolInputHidden": "（展開檢視內容）",
  ...
  en: {
    ...
    "field.successSignalsHelp":
      "List observable signs of success; ideally pair at least one with a measurable metric and threshold so you can verify it later.",
    "field.successSignalsPlaceholder":
      "e.g. Decrease in average task time, higher satisfaction scores, fewer support requests.",
    "field.successSignalStatement": "Statement",
    "field.successSignalStatementHelp": "Describe in one sentence what success looks like.",
    "field.successSignalStatementPlaceholder": "e.g. Sign-up conversion rate improves by 15%",
    "field.successSignalMetric": "Metric (optional)",
    "field.successSignalMetricHelp": "Name of the metric, dashboard field, or event you would track.",
    "field.successSignalMetricPlaceholder": "e.g. signup_completion_rate",
    "field.successSignalThreshold": "Threshold (optional)",
    "field.successSignalThresholdHelp": "Pass condition, expressed as a number, ratio, or range.",
    "field.successSignalThresholdPlaceholder": "e.g. > 0.15, < 5/week",
    "field.successSignalKind": "Signal kind (optional)",
    "field.successSignalKindHelp": "Leading indicators predict; lagging indicators confirm.",
    "kind.leading": "Leading",
    "kind.lagging": "Lagging",
    "kind.unset": "Not set",
    ...
    "validation.successSignalsNotMeasurable":
      "None of the current success signals carry a measurable metric/threshold; pair at least one with a verifiable data contract so build–measure–learn stays honest.",
...
`,
    ...
    "seedPrompt.button.sendToAgent": "→ Send to AI Agent panel",
    "seedPrompt.button.sentToAgent": "Sent ✦",
    ...
    "assistant.title": "Local AI Agent",
    "assistant.warning":
      "⚠ This agent can read/write project files and run shell commands (bypassPermissions). Each request runs in a fresh session.",
    "assistant.placeholder": "e.g. Use vector-pipeline-b stage 1 for: I want to build a habit tracker",
    "assistant.send": "Send",
    "assistant.sending": "Working…",
    "assistant.abort": "Abort",
    "assistant.clear": "Clear conversation",
    "assistant.collapse": "Collapse",
    "assistant.expand": "Open AI Assistant",
    "assistant.empty": "Type a request — the agent will read/write files in this project and report progress.",
    "assistant.you": "You",
    "assistant.agent": "Agent",
    "assistant.toolResult": "Result",
    "assistant.toolError": "Error",
    "assistant.toolInputHidden": "(expand to view)",
